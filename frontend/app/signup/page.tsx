        ...
        <div className="auth-card-wide">
          ...
          >
            ...
            <div>
              ...
              {formErrors.femail && (
                <p className="error">{formErrors.femail}</p>
              )}
            </div>
            ...
            <div>
              ...
              >
                <input
                  ...
                  className={`input ${
                    formErrors.fpass ? "border-red-500" : ""
                  }`}
                  style={{
                    paddingRight: "40px",
                  }}
            ...
            <div>
              ...
              {formErrors.fphone && (
                <p className="error">{formErrors.fphone}</p>
              )}
            </div>
            ...
            <div>
              <select
                name="frole"
                className={`input ${formErrors.frole ? "border-red-500" : ""}`}
              >
              ...
              {formErrors.frole && <p className="error">{formErrors.frole}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`mt-2 block w-full text-sm text-slate-600 ${
                  formErrors.file ? "border border-red-500 rounded-lg p-2" : ""
                }`}
                onChange={handleImageChange}
              />

              <p className="text-xs text-gray-500 mt-1">
                Only PNG, JPG, JPEG allowed (Max 2MB)
              </p>
